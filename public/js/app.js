...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_timers__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_MessageList_vue__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_MessageList_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__components_MessageList_vue__);
/**
 * Init components
 */
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_1_vue_timers__["a" /* default */]);

__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('message-list', __WEBPACK_IMPORTED_MODULE_2__components_MessageList_vue___default.a);
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6a7499aa", Component.options)
  } else {
    hotAPI.reload("data-v-6a7499aa", Component.options)
  }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Message_vue__ = __webpack_require__(40);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: { Message: __WEBPACK_IMPORTED_MODULE_0__Message_vue___default.a },
    ...
    methods: {
        ...
        save_problems: function save_problems(response) {
            if (response.data.hasOwnProperty('error')) this.error = response.data.error;

            if (response.data.hasOwnProperty('warning')) this.warning = response.data.warning;
        },
        ...
        validate_request: function validate_request(response, type) {
            switch (type) {
                case "check":
                    if (this.mod_time !== response.data.mod_time) this.clear_problems();

                    this.save_problems(response);

                    if (this.has_problem()) if (this.mod_time !== null) return this.mod_time;else return null;
      ...
      _vm._l(_vm.messages, function(message) {
        return _c("message", {
          ...
          attrs: {
            ...
            image: message.hasOwnProperty("user_image")
              ? message.user_image
              : ""
          }
        })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-6a7499aa", module.exports)
  }
}
